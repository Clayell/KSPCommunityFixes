    ...
    class RCSLimiter : BasePatch
    {
        protected override void ApplyPatches(ref List<PatchInfo> patches)
        {
            patches.Add(new PatchInfo(
                ...
                AccessTools.Method(typeof(ModuleRCS), nameof(ModuleRCS.OnAwake)),
                this));

            patches.Add(new PatchInfo(
                PatchMethodType.Postfix,
                AccessTools.Method(typeof(ModuleRCS), nameof(ModuleRCS.OnDestroy)),
                this));

            patches.Add(new PatchInfo(
                PatchMethodType.Postfix,
                AccessTools.Method(typeof(ModuleRCS), nameof(ModuleRCS.UpdateToggles)),
                this));

            patches.Add(new PatchInfo(
                PatchMethodType.Prefix,
                AccessTools.Method(typeof(ModuleRCS), nameof(ModuleRCS.FixedUpdate)),
                this));
